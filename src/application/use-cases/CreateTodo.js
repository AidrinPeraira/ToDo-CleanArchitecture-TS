...
var Todo_js_1 = require("../../domain/entities/Todo.js");
...
var CreateTodo = /** @class */ (function () {
    function CreateTodo(toDoRepository) {
        this.toDoRepository = toDoRepository;
    }
    CreateTodo.prototype.execute = function (title, description) {
        return __awaiter(this, void 0, void 0, function () {
            var uid, newToDo, createToDo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        uid = (0, uuid_1.v4)();
                        newToDo = new Todo_js_1.ToDo(uid, title, description, false);
                        return [4 /*yield*/, this.toDoRepository.create(newToDo)];
                    case 1:
                        createToDo = _a.sent();
                        return [2 /*return*/, createToDo]; // return the result
                }
            });
        });
    };
